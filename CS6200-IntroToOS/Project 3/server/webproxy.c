...
"  -t [thread_count]   Num worker threads (Default: 3, Range: 1-512)\n"               \
...
int main(int argc, char **argv) {
  ...
  while ((option_char = getopt_long(argc, argv, "xp:hs:t:", gLongOptions, NULL)) != -1) {
    switch (option_char) {
      default:
