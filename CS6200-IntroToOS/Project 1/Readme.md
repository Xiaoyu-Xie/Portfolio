...
* gfclient.h - (do not modify) header file for the gfclient library
* gfclient-student.h - (mdo not modify) header file for students to modify - submitted for client only
...
* gfserver.h - (do not modify) header file for the gfserver library.
* gfserver-student.h - (do not modify) header file for students to modify - submitted for server only
* gfserver_main.c (modify and submit) the main file for the Getfile server.
  Illustrates the use of the gfserver library.
* gf-student.h (do not modify) header file for students to modify - submitted for both client and server
