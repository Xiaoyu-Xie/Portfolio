...
;;
;;
	c0    mpylu $r0.8 = $r0.2, $r0.5   
	c0    mpyhs $r0.9 = $r0.2, $r0.5   
;;
;;
	c0    add $r0.8 = $r0.8, $r0.9   
;;
	c0    add $r0.8 = $r0.8, $r0.7   
...
;;
	c0    mpylu $r0.11 = $r0.9, $r0.6   
;;
;;
	c0    mpyhs $r0.6 = $r0.9, $r0.6   
;;
;;
	c0    add $r0.11 = $r0.11, $r0.6   
	c0    add $r0.9 = $r0.9, $r0.7   
;;
